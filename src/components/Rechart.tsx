...
const getIntroOfPage = (label: string | number | undefined) => {
  ...
  if (label === 'Fev') {
    return "Fev is about women's dress";
  }
  if (label === 'Mas') {
    return "Mas is about women's bag";
  }
  if (label === 'Avl') {
    return 'Avl is about household goods';
  }
  if (label === 'Mai') {
    return 'Mai is about food';
  }
  if (label === 'Jun') {
    return 'Jun is about baby food';
  }
  if (label === 'Jue') {
    return 'Jue is about food'
  }
  return '';
};
