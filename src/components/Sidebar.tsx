...
import { Home, FileText, Users, LogOut, Inbox, CreditCard, Wallet, PieChart } from 'lucide-react';
    ...
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <nav className="flex-1 p-4">
        ...
        <button
          ...
          className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-2 transition-colors ${
            activeMenu === 'Transaction' ? 'bg-blue-100 text-blue-600' : 'text-gray-700 hover:bg-gray-50'
          }`}
        >
          <CreditCard size={20} />
        ...
        <button
          ...
          className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
            activeMenu === 'Budget' ? 'bg-blue-100 text-blue-600' : 'text-gray-700 hover:bg-gray-50'
          }`}
        >
          <Wallet size={20} />
