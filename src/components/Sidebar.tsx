      ...
      <nav className="flex-1 p-4">
        <button
          ...
          className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-2 transition-colors ${
            activeMenu === 'dashboard' ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-50'
          }`}
        >
          <Home size={20} />
        ...
        <button
          ...
          className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-2 transition-colors ${
            activeMenu === 'invoices' ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-50'
          }`}
        >
          <FileText size={20} />
        ...
        <button
          ...
          className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
            activeMenu === 'customers' ? 'bg-blue-50 text-blue-600' : 'text-gray-700 hover:bg-gray-50'
          }`}
        >
          <Users size={20} />
