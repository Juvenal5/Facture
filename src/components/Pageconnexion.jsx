...
// interface Pageconnexion {
//   onAuthSuccess: () => void;
// }

// export default function PageConnexion({ onAuthSuccess }: Pageconnexion) {
//   const [showLoginModal, setShowLoginModal] = useState(false);
//   const [showSignupModal, setShowSignupModal] = useState(false);
...
//     if (email && password) {
//       alert('Connexion réussie !');
//       // Appeler la fonction pour permettre l'accès
//       onAuthSuccess();
//     }
//   };
...
//     alert('Inscription réussie ! Bienvenue sur FinBoard.');
//     // Appeler la fonction pour permettre l'accès
//     onAuthSuccess();
//   };
